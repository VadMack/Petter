...
internal class InitRegistrationConfirmActor(
    ...
    override fun process(commands: Flow<RegistrationConfirmCommand>): Flow<RegistrationConfirmEvent> {
        return commands.filterIsInstance<RegistrationConfirmCommand.InitConfirm>()
            .flatMapLatest { repository.initRegistrationConfirm() }
            .map(RegistrationConfirmEvent::ConfirmationStatus)
    }
}
