...
internal class RegistrationConfirmActor(
    ...
    override fun process(commands: Flow<RegistrationConfirmCommand>): Flow<RegistrationConfirmEvent> {
        return commands.filterIsInstance<RegistrationConfirmCommand.Confirm>()
            .flatMapLatest { repository.registrationConfirm(it.model) }
