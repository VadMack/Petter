...
internal class RegistrationDeclineActor(
    ...
    override fun process(commands: Flow<RegistrationCommand>): Flow<RegistrationEvent> {
        return commands.filterIsInstance<RegistrationCommand.DeclineRegistration>()
            .mapLatest { repository.declineRegistration(it.email) }
